...
def write_ply(points, filename, text=True):
    """ input: N×3, write points to filename as PLY format. """
...
def draw_point_cloud(input_points, canvasSize=500, space=200, diameter=25,
    ...
    """ Render point cloud to image with alpha channel.
        将点云渲染成带有alpha通道的图像。
        Input:
            points: N×3 numpy array (+y is up direction)
        Output:
            gray image as numpy array of size canvasSize × canvasSize
    """
...
def point_cloud_three_views_demo():
    """ Demo（演示） for draw_point_cloud function """
