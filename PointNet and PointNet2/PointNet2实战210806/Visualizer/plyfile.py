...
#
#   Python PLYFILE是免费软件：您可以根据自由软件基金会发布的GNU通用公共许可证的条款
#   对其进行重新分发和/或修改，或者许可证的第3版，或者（按您的选择）任何后续版本。
#
...
#
#   python plyfile的发布是希望它有用，但没有任何保证；甚至没有对适销性或特定用途
#   适用性的默示保证。有关更多详细信息，请参阅GNU通用公共许可证。
#
